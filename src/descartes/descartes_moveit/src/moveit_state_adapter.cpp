...
/*  CONSOLE_BRIDGE_logDebug("Found %lu joint solutions out of %lu iterations",
...
*/
  ...
  {
/*
    CONSOLE_BRIDGE_logError("Found 0 joint solutions out of %lu iterations",
                            static_cast<unsigned long>(seed_states_.size()));
*/
    return false;
  }
  ...
  {
/*
    CONSOLE_BRIDGE_logInform("Found %lu joint solutions out of %lu iterations",
                             static_cast<unsigned long>(joint_poses.size()),
                             static_cast<unsigned long>(seed_states_.size()));
*/
    return true;
